        ...
        <div class="auth-form-side">
            <div class="auth-card">
                ...
                <form method="POST" action="/login" novalidate>
                    <input type="hidden" name="_csrf" value="token-de-exemplo">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="password">
                            SENHA
                            <a href="/recuperar-senha" class="form-label-link">Esqueceu a senha?</a>
                        </label>
                        <div class="input-password-wrapper">
                            <input class="form-input" type="password" id="password" name="password"
                                   required autocomplete="current-password" placeholder="••••••••">
                            <button type="button" class="password-toggle" onclick="togglePassword()" title="Mostrar senha">
                    ...
                    <div class="checkbox-group">
                        ...
                        <label class="form-label" for="remember">Lembrar de mim por 30 dias</label>
                    </div>
                    ...
                    <div class="recaptcha-wrapper">
                        ...
                        <div class="recaptcha-placeholder">
                            <div class="recaptcha-placeholder-inner">
                            ...
                            <div class="recaptcha-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 64 64"><path fill="#4A90D9" d="M32 4C16.536 4 4 16.536 4 32s12.536 28 28 28 28-12.536 28-28S47.464 4 32 4z"/><path fill="#fff" d="M32 14c-9.941 0-18 8.059-18 18s8.059 18 18 18 18-8.059 18-18-8.059-18-18-18zm0 8a10 10 0 1 1 0 20 10 10 0 0 1 0-20z"/></svg>
                                <div class="recaptcha-logo-text">
                                    <span class="recaptcha-brand">reCAPTCHA</span>
                                    <span class="recaptcha-terms">Privacidade · Termos</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="social-login">
                    ...
                    <button type="button" class="btn-social btn-discord">
